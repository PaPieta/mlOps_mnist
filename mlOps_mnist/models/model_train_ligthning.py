...
def train(config):
    ...
    trainer = Trainer(callbacks=[early_stopping_callback], max_epochs=train_hparams["n_epochs"], \
                      accelerator="gpu", logger=WandbLogger(project="fashion_mnist_mlops"),precision="16-mixed")
